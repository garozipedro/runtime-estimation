...
static RegisterPass<StaticFunctionCostPass> X("static-function-cost",
                "Statically estimate a function cost based on basic block and edge frequencies", true, true);
